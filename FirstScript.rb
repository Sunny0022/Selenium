...
@driver.get ("https://vinsol:v1ns0l@staging.dev.socialimprints.com")
sleep 5
@driver.find_element(:xpath, '/html/body/div[8]/section/div[2]/a').click
sleep 4
@driver.find_element(:css, '#identifierId').send_keys('aryasunny123@gmail.com')
@driver.action.send_keys(:enter).perform
sleep 2
@driver.find_element(:css, '.I0VJ4d > div:nth-child(1) > input:nth-child(1)').send_keys("Rubyupon@123,./,./")
@driver.action.send_keys(:enter).perform
sleep 10
...
sleep 2
@driver.find_element(:css, 'div.form-control-group:nth-child(3) > input:nth-child(1)').send_keys('Blankets')
...
@driver.find_element(:id, 'accept_by_date').send_keys('05/19/2020')
@driver.action.send_keys(:enter).perform
...
@driver.find_element(:id, 'due_date').send_keys('05/22/2020')
@driver.action.send_keys(:enter).perform
...
@driver.action.send_keys(:enter).perform
  ...
  @driver.find_element(:id, 'form-id').click
  sleep 5
@driver.find_element(:xpath, '/html/body/div[9]/header/article/div/div/aside[2]/dd/dl[3]/div/a/span').click
@driver.find_element(:xpath, '/html/body/div[9]/header/article/div/div/aside[2]/dd/dl[3]/div/ul/li[4]/form').click
sleep 5
@driver.quit
